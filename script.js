...
const SERVICOS = [
    ...
    { nome: 'Corte Tesoura', valor: 40.00 },
    { nome: 'Alisamento Americano', valor: 45.00 },
    { nome: 'Corte Infantil', valor: 40.00 },
    { nome: 'Blindado', valor: 110.00 },
    { nome: 'Corte + Barba + Alisamento Prime', valor: 150.00 },
    { nome: 'Corte Fantasia', valor: 60.00 },
    { nome: 'Barba + Sobrancelha', valor: 50.00 },
    { nome: 'Corte + Barba + Sobrancelha', valor: 80.00 },
    { nome: 'Corte + Alisamento Prime', valor: 90.00 },
    { nome: 'Corte + Progressiva', valor: 100.00 },
